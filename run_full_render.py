...
# 2. Build RenderRequest without specifying range limits for full render
setup_data["setup_name"] = "full_60fps"
setup_data["range_start"] = None
setup_data["range_end"] = None
...
# 3. Trigger render
try:
    print("Starting full render via render_video...")
