...
export function getEditorElements() {
    ...
    slotTransitionSelect: document.getElementById('slot-transition-select'),
    slotTransitionStatus: document.getElementById('slot-transition-status'),
    ...
    dialogueTimelineStart: document.getElementById('dialogue-timeline-start'),
    dialogueTimelineEnd: document.getElementById('dialogue-timeline-end'),
    dialogueSourceStart: document.getElementById('dialogue-source-start'),
    ...
    autoTransitionBtn: document.getElementById('auto-transition-btn'),
    loadSetupBtn: document.getElementById('load-setup-btn'),
    lyricCssInput: document.getElementById('lyric-css-input'),
    ...
    dialogueVolumeInput: document.getElementById('dialogue-volume-input'),
