...
export function getEditorElements() {
    ...
    independentDialogueCanvas: document.getElementById('independent-dialogue-canvas'),
    ...
    slotSegmentsPanel: document.getElementById('slot-segments-panel'),
    slotSegmentsList: document.getElementById('slot-segments-list'),
    addSegmentBtn: document.getElementById('add-segment-btn'),
    slotSpeakerSelect: document.getElementById('slot-speaker-select'),
    ...
    dialogueVolumeValue: document.getElementById('dialogue-volume-value'),
