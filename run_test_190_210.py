...
# 2. Build RenderRequest with range limits for 190-210s test
setup_data["setup_name"] = "test_190_210"
setup_data["range_start"] = 190.0
setup_data["range_end"] = 210.0
...
# 3. Trigger render
try:
    print("Starting 190-210s test render via render_video...")
